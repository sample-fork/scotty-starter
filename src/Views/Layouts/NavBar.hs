  ...
  nav ! class_ "navbar navbar-default" ! customAttribute "role" "navigation" $ do
    div ! class_ "container-fluid" $ do
      ...
      div ! class_ "navbar-header" $ do
        button ! type_ "button" ! class_ "navbar-toggle collapsed" ! dataAttribute "toggle" "collapse" ! dataAttribute "target" "#bs-example-navbar-collapse-1" $ do
      ...
      div ! class_ "collapse navbar-collapse" ! id "bs-example-navbar-collapse-1" $ do
